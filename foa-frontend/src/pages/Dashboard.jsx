...
const tabs = ['Cotizaciones', 'Documentacion', 'Mi Empresa', 'Historial'];
...
export default function Dashboard({ onLogout }) {
  ...
  return (
    <>
      <div style={{ background: 'linear-gradient(135deg,#1a365d,#2d6a9f)', color: 'white', padding: '1.5rem 0' }}>
        <div className="container">
          <div className="d-flex justify-content-between align-items-center">
            <div>
              <h2 className="fw-bold mb-0" style={{ color: 'white' }}>Forwarding Operations Assistant</h2>
              <p className="mb-0 mt-1" style={{ opacity: .8, fontSize: '.9rem' }}>Herramienta profesional de comercio exterior</p>
            </div>
